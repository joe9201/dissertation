...
export async function main() {
  ...
  if (!queuedFederated.includes('@jupyter-notebook/lab-extension')) {
    try {
      let ext = require('@jupyter-notebook/lab-extension');
      ext.__scope__ = '@jupyter-notebook/lab-extension';
      for (let plugin of activePlugins(ext)) {
        register.push(plugin);
      }
    } catch (e) {
  ...
  if (!queuedFederated.includes('@jupyter-widgets/jupyterlab-manager')) {
    try {
      ...
      ext.__scope__ = '@jupyter-widgets/jupyterlab-manager';
      for (let plugin of activePlugins(ext)) {
        register.push(plugin);
      }
    } catch (e) {
